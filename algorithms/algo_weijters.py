...
dictionary_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'dictionary_celex.csv')
...
# (main function at very bottom called syllabificate_weijers)
...
def weijters_syllabificate(word, checks=0, print_toggle=False):
